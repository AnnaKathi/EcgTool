...
CREATE TABLE Erkennungswerte (
  ...
  Algorithmen_ID INTEGER UNSIGNED NOT NULL,
  Erkennungswert VARCHAR(1024) NOT NULL,
  PRIMARY KEY(ID),
  INDEX Erkennungswerte_FKIndex1(Algorithmen_ID),
...
CREATE TABLE ECGData (
  ...
  Sessions_ID INTEGER UNSIGNED NOT NULL,
  Subjects_ID INTEGER UNSIGNED NOT NULL,
  Platzierung_ID INTEGER UNSIGNED NOT NULL,
  ...
  INDEX ECGData_FKIndex4(Platzierung_ID),
