...
__published:	// IDE-verwaltete Komponenten
	...
	TAction *acSessionShow;
	TPopupMenu *PopupMenuSessions;
	TMenuItem *Sessionsanzeigen1;
	...
	void __fastcall acDatabaseEcgDataExecute(TObject *Sender);
	void __fastcall acDatabasePeopleExecute(TObject *Sender);
	void __fastcall acSessionAddExecute(TObject *Sender);
	void __fastcall acSessionShowExecute(TObject *Sender);
